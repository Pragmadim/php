...
<form action="" method="post">
    <div class="forms" id="calendar">
        <input class="form-control" name="calendar" type="date" placeholder="Укажите дату">
    </div>

    <div class="forms" id="track">
        <input class="form-control" name="track" type="text" placeholder="Трек-номер">
    </div>

    <div class="forms" id="money">
        <input class="form-control" name="money" type="number" step="0.01" placeholder="Сумма">
    </div>
